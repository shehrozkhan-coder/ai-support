    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Have a question, need support, or want to work together?  
      ...
      <section className="border-t border-zinc-200 bg-white py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-8 text-zinc-600 text-lg leading-relaxed text-center max-w-3xl mx-auto">
            I am a professional full-stack developer with strong experience in
            MERN stack and Next.js. I work at an engineer level, focusing on
            scalable architecture, clean code, and production-ready systems.
          </p>
